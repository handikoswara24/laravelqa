                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <form id="up-vote-question-{{$question->id}}" method="POST"
                                action="/questions/{{ $question->id }}/vote" class="d-none">
                                @csrf
                            ...
                            <form id="down-vote-question-{{$question->id}}" method="POST"
                                action="/questions/{{ $question->id }}/vote" class="d-none">
                                @csrf
                                <input type="hidden" name="vote" value="-1">
                            </form>
                            ...
                            <form id="favorite-question-{{$question->id}}" method="POST"
                                action="/questions/{{ $question->id }}/favorites" class="d-none">
                                @csrf
